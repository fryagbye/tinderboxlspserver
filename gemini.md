...
12. **README.mdへの追記**: 機能追加や仕様変更を行った場合は、README.mdにも追記すること。その際、バージョンと日付を忘れずに記載すること。言語は英語とすること。
13. **CHANGELOG.mdへの追記**: 機能追加や仕様変更を行った場合は、CHANGELOG.mdにも追記すること。その際、バージョンと日付を忘れずに記載すること。言語は英語とすること。
